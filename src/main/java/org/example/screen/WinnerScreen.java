...
public class WinnerScreen extends ScreenAdapter {
    ...
    public WinnerScreen(Game game, ScoreBroad broad) {
        this.game = game;
        this.broad = broad;
        ...
        if (game != null) {
            ...
            Gdx.app.log("winner screen", "enter winner screen");
            ...
            Timer.schedule(new Timer.Task() {
                ...
                public void run() {
                    ...
                    game.setScreen(new PlayerScreen(game, broad.getGoal()*2));
                }
            }, 3);
        }
    }
    ...
    @Override
    public void show() {
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("music/win.wav"));
    ...
    private void setupUI() {
        ...
        font.draw(batch, "Succeed!!!", CENTER_X * 0.95f, TITLE_Y);
        ...
        font.getData().setScale(1.2f);
        font.draw(batch, "Your Goal Achieved ", CENTER_X * 0.90f, GOAL_Y);
    }
